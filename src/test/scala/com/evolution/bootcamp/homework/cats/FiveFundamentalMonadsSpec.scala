...
import com.evolution.bootcamp.homework.cats.FiveFundamentalMonads._

class FiveFundamentalMonadsSpec extends PropSpec with ScalaCheckPropertyChecks with Matchers {
